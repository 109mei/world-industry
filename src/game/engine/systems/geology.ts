...
const TABLE: Record<TerrainId, Chance[]> = {
  mountain: [
    ...
    { id: 'silver_ore', p: 0.05, per: 1.4 },
    { id: 'gold_ore', p: 0.008, per: 0.5 },
    { id: 'rough_gem', p: 0.004, per: 0.12 },
  ],
  forest: [
    { id: 'wood', p: 1, per: 30 },
  ...
  plains: [
    ...
    { id: 'crude_oil', p: 0.012, per: 9 },
  ],
  desert: [
    { id: 'sand', p: 1, per: 60 },
    { id: 'rough_gem', p: 0.006, per: 0.1 },
    { id: 'crude_oil', p: 0.06, per: 26 },
  ...
  coast: [
    ...
    { id: 'crude_oil', p: 0.025, per: 18 },
  ],
  river: [
    { id: 'water', p: 1, per: 60 },
    { id: 'sand', p: 0.6, per: 25 },
    { id: 'clay', p: 0.5, per: 18 },
    { id: 'gold_ore', p: 0.012, per: 0.35 },
  ],
  snow: [
    { id: 'stone', p: 0.7, per: 20 },
    { id: 'crude_oil', p: 0.03, per: 22 },
