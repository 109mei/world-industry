...
export const LANDS = [
  {
    id: 'jp_hokkaido', name: '北海道・十勝', nameEn: 'Tokachi, Hokkaido', country: 'JP', region: '北海道', terrain: 'plains', price: 300_000, population: 0.3, lat: 42.9, lon: 143.2,
    deposits: { coal: 120_000 },
    description: '広い平原。農園に最適で、小さな炭鉱もある。最初の土地に向く。',
    unlock: { type: 'always' },
  },
  {
    id: 'jp_chikuho', name: '九州・筑豊', nameEn: 'Chikuho, Kyushu', country: 'JP', region: '福岡', terrain: 'mountain', price: 600_000, population: 0.6, lat: 33.6, lon: 130.7,
    deposits: { coal: 400_000, iron_ore: 150_000 },
    description: '山あいの炭田地帯。石炭と鉄鉱石の両方が採れる。',
    unlock: { type: 'always' },
  },
  {
    id: 'jp_tokyo', name: '東京湾岸', nameEn: 'Tokyo Bay', country: 'JP', region: '東京', terrain: 'city', price: 8_000_000, population: 3, lat: 35.6, lon: 139.8,
    deposits: {},
    description: '人口と交通量が圧倒的。商業施設の収益が高く、港もある。',
    unlock: { type: 'assets', min: 5_000_000 },
  },
  {
    id: 'no_vestland', name: 'ノルウェー西部', nameEn: 'Vestland, Norway', country: 'NO', region: 'ヴェストラン', terrain: 'river', price: 5_000_000, population: 0.3, lat: 60.4, lon: 5.3,
    deposits: {},
    description: 'フィヨルドと急流。水力発電に最適で、電力を安く大量に作れる。',
    unlock: { type: 'research', research: 'overseas' },
  },
  {
    id: 'us_mesabi', name: 'ミネソタ・メサビ', nameEn: 'Mesabi Range, Minnesota', country: 'US', region: 'ミネソタ', terrain: 'forest', price: 3_000_000, population: 0.3, lat: 47.4, lon: -92.9,
    deposits: { iron_ore: 3_000_000 },
    description: '巨大な鉄鉱床と広い森林。鉄と木材の一大拠点になる。',
    unlock: { type: 'research', research: 'overseas' },
  },
  {
    id: 'us_texas', name: 'テキサス・パーミアン', nameEn: 'Permian Basin, Texas', country: 'US', region: 'テキサス', terrain: 'desert', price: 4_000_000, population: 0.8, lat: 32.0, lon: -102.1,
    deposits: { crude_oil: 2_000_000 },
    description: '大油田と強い日差し。油田と太陽光発電に向く。',
    unlock: { type: 'research', research: 'overseas' },
  },
  {
    id: 'cn_shanxi', name: '山西', nameEn: 'Shanxi', country: 'CN', region: '山西省', terrain: 'mountain', price: 3_500_000, population: 1, lat: 37.9, lon: 112.5,
    deposits: { coal: 5_000_000 },
    description: '世界有数の石炭産地。火力発電の燃料に困らない。',
    unlock: { type: 'research', research: 'overseas' },
  },
  {
    id: 'de_ruhr', name: 'ルール工業地帯', nameEn: 'Ruhr, Germany', country: 'DE', region: 'ノルトライン', terrain: 'industrial', price: 10_000_000, population: 2, lat: 51.5, lon: 7.0,
    deposits: { coal: 600_000 },
    description: '伝統ある工業地帯。工場と商業の両方に強い。',
    unlock: { type: 'research', research: 'overseas' },
  },
  {
    id: 'cl_atacama', name: 'アタカマ', nameEn: 'Atacama, Chile', country: 'CL', region: 'アントファガスタ', terrain: 'desert', price: 6_000_000, population: 0.2, lat: -23.6, lon: -70.4,
    deposits: { copper_ore: 2_500_000 },
    description: '世界最大級の銅鉱床。乾燥した高地で太陽光も強い。',
    unlock: { type: 'research', research: 'overseas' },
  },
  {
    id: 'au_pilbara', name: 'ピルバラ', nameEn: 'Pilbara, Australia', country: 'AU', region: '西オーストラリア', terrain: 'desert', price: 9_000_000, population: 0.1, lat: -20.3, lon: 118.6,
  ...
  {
    id: 'br_carajas', name: 'カラジャス', nameEn: 'Carajás, Brazil', country: 'BR', region: 'パラ州', terrain: 'forest', price: 7_000_000, population: 0.4, lat: -6.1, lon: -50.2,
  ...
  {
    id: 'sa_ghawar', name: 'ガワール', nameEn: 'Ghawar, Saudi Arabia', country: 'SA', region: '東部州', terrain: 'desert', price: 25_000_000, population: 0.3, lat: 25.4, lon: 49.6,
  ...
  {
    id: 'au_olympic', name: '南オーストラリア', nameEn: 'South Australia', country: 'AU', region: '南オーストラリア', terrain: 'desert', price: 15_000_000, population: 0.2, lat: -30.5, lon: 136.9,
  ...
  {
    id: 'ca_athabasca', name: 'アサバスカ', nameEn: 'Athabasca, Canada', country: 'CA', region: 'サスカチュワン', terrain: 'snow', price: 20_000_000, population: 0.1, lat: 57.8, lon: -105.0,
