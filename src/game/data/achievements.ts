...
export const ACHIEVEMENTS: AchievementDef[] = [
  ...
  { id: 'prospector', name: '山師', description: '買った土地を試掘まで調べる。', icon: 'icon_machine_drilling_rig', check: (s) => s.lands.some((l) => l.id.startsWith('osm:') && l.survey >= 3) },
  ...
  { id: 'material_master', name: '素材マスター', description: '20種類以上の資源を手に入れる。', icon: 'icon_ui_box', check: (s) => Object.keys(s.stats.totalObtained).length >= 20 },
