...
export const RESEARCH = [
  ...
  { id: 'semiconductor', name: '半導体産業', icon: 'icon_material_semiconductor', branch: 'industry', cost: 2500, requires: ['advanced_materials', 'commerce'], effects: [{ type: 'unlock', text: 'シリコン精製所・半導体工場' }], description: 'シリコン精製所と半導体工場を建てられる。半導体は1個5万円。' },
  ...
  { id: 'automotive', name: '自動車産業', icon: 'icon_facility_vehicle_factory', branch: 'industry', cost: 1200, requires: ['advanced_materials'], effects: [{ type: 'unlock', text: 'ゴム農園・自動車工場' }], description: 'ゴム農園と自動車工場を建てられる。自動車は1台300万円で売れる。' },
