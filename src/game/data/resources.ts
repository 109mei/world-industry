...
export const RESOURCES = [
  ...
  { id: 'coal', name: '石炭', nameEn: 'Coal', category: 'ore', basePrice: 10, weight: 0.04, icon: 'icon_resource_coal', sellable: true, liquidity: 1500, description: '鋼鉄の生産や火力発電に使う（今後解放）。' },
  ...
  { id: 'steel', name: '鋼鉄', nameEn: 'Steel', category: 'material', basePrice: 120, weight: 0.05, icon: 'icon_material_steel', sellable: true, liquidity: 200, description: '鉄と石炭から作る高強度の金属（今後解放）。' },
