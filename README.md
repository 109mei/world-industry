...
- 総資産が 300万円に達すると **ESTATE** 画面が解放。**実在の地図**（OpenStreetMap / CARTO のタイル、ズーム・ドラッグ可）に、実在の場所の土地・物件 102 件を置いてある。ズームアウト時は都市ごとの数字、寄るとピン（色は種類、金色の枠が所有、点線が他社所有）。会社の本社と LAND 画面の産業用地も表示
